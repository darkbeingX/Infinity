...
allowed-tools: Bash(npx *) mcp__claude-flow__memory_usage Read Write
...
Store init event:
`mcp__claude-flow__memory_usage({ action: "store", key: "federation-init", value: "Node initialized", namespace: "federation" })`
